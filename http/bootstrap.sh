...
nvram IASUCatalogURL=https://swscan.apple.com/content/catalogs/others/index-12-10.16-10.15-10.14-10.13-10.12-10.11-10.10-10.9-mountainlion-lion-snowleopard-leopard.merged-1.sucatalog
...
do
   /Volumes/Image\ Volume/Install*.app/Contents/Resources/startosinstall --agreetolicense --installpackage vagrant.pkg --installpackage setupsshlogin.pkg --volume /Volumes/macOS && break
